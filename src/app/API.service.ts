...
export class APIService {
  ...
  async ListChatties(
    ...
    limit?: number,
    nextToken?: string
  ): Promise<ListChattiesQuery> {
    const statement = `query ListChatties($filter: ModelChattyFilterInput, $limit: Int, $nextToken: String) {
    ...
    return <ListChattiesQuery>response.data.listChatties;
  }
  async SyncChatties(
    filter?: ModelChattyFilterInput,
    limit?: number,
